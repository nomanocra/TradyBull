...
class MACDHistogramSL1Strategy(BaseStrategy):
    """
    MACD Histogram Reversal Strategy with Stop Loss
    ...
    @property
    def name(self) -> str:
        return "macd-histogram-sl1"

    @property
    def display_config(self) -> StrategyDisplayConfig:
        return StrategyDisplayConfig(
            display_name="MACD Histogram SL-1%",
            description="BUY: histogram negative + rising. SELL: SL -1% or histogram positive + falling.",
            show_macd=True,
        )

    @property
    def required_lookback(self) -> int:
        return MACD_SLOW + MACD_SIGNAL + 2
