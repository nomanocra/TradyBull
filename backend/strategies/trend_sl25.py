...
class TrendSL25Strategy(BaseStrategy):
    """
    Trend Following Strategy with -2.5% Stop Loss
    ...
    def display_config(self) -> StrategyDisplayConfig:
        return StrategyDisplayConfig(
            display_name="Trend SL-2.5%",
            description="Buy when trend turns bullish (price > MA200 and MA200 rising). Sell when trend turns bearish. Stop loss at -2.5%. Holds position while trend is bullish.",
