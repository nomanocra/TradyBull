...
class IchimokuKumoSL1Strategy(BaseStrategy):
    """
    Ichimoku Kumo (Cloud) Breakout Strategy with Stop Loss
    ...
    @property
    def name(self) -> str:
        return "ichimoku-kumo-sl1"

    @property
    def display_config(self) -> StrategyDisplayConfig:
        return StrategyDisplayConfig(
            display_name="Ichimoku Kumo SL-1%",
            description="BUY: price above cloud. SELL: SL -1% or price enters/below cloud.",
            show_ichimoku=True,
        )
