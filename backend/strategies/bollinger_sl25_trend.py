...
class BollingerSL25TrendStrategy(BaseStrategy):
    ...
    def display_config(self) -> StrategyDisplayConfig:
        return StrategyDisplayConfig(
            ...
            description="Buy when price touches lower Bollinger Band AND price > MA200 AND MA200 is rising. Stop loss at -2.5%. Position closes at 22h Paris time. One trade per day max.",
            show_bollinger=True,
    ...
    def calculate_signals(
        ...
        for i in range(start_index, len(candles)):
            ...
            if low_below_band and is_in_trading_hours and not last_signal_triggered and not has_position_today and trend_ok:
